...
(function(global) {
  function buildBemXjst(libs) {
        ...
        })()(
          {
            1: [
              function(require, module, exports) {
                ...
                Entity.prototype.init = function(block, elem) {
                  ...
                  // Class for jsParams
                  this.jsClass = this.bemxjst.classBuilder.build(
                    this.block,
                    this.elem
                  );
                };
            ...
            2: [
              function(require, module, exports) {
                ...
                function BEMHTML(options) {
                  ...
                  this._shortTagCloser =
                    typeof options.xhtml !== "undefined" && options.xhtml
                      ? "/>"
                      : ">";
                  ...
                  this._unquotedAttrs =
                    typeof options.unquotedAttrs === "undefined"
                      ? false
                ...
                BEMHTML.prototype.render = function(
                  context,
                  entity,
                  tag,
                  js,
                  ...
                  if (isBEM) {
                    ...
                    classValue += this.buildModsClasses(
                      entity.block,
                      entity.elem,
                  ...
                  out +=
                    this._unquotedAttrs && utils.isUnquotedAttr(classValue)
                      ? classValue
                      : '"' + classValue + '"';
                ...
                var OPTIONAL_END_TAGS = {
                  ...
                  /* dl — Neither tag is omissible */ rb: 1,
                  rt: 1,
                  rtc: 1,
                  rp: 1,
                  optgroup: 1
                ...
                BEMHTML.prototype.renderClose = function(
                  prefix,
                  context,
                  tag,
                  attrs,
                ...
                BEMHTML.prototype.renderMix = function(
                  ...
                  for (var i = 0; i < mix.length; i++) {
                    ...
                    if (item.elem) {
                      hasItem =
                        (item.elem !== entity.elem &&
                          item.elem !== context.elem) ||
                        (item.block && item.block !== entity.block);
                    } else if (item.block) {
                      hasItem =
                        !(item.block === entity.block && item.mods) ||
                    ...
                    for (var j = 0; j < nestedMix.length; j++) {
                      ...
                      if (
                        (!nestedItem.block && !nestedItem.elem) ||
                        !visited[
                          classBuilder.build(nestedItem.block, nestedItem.elem)
                        ]
                      ) {
                        ...
                        mix = mix
                          .slice(0, i + 1)
                          .concat(nestedItem, mix.slice(i + 1));
                      }
                    }
                  }
                ...
                BEMHTML.prototype.buildModsClasses = function(
                  block,
                  elem,
                  mods
                ) {
            ...
            3: [
              function(require, module, exports) {
                ...
                ClassBuilder.prototype.build = function(block, elem) {
                  if (!elem) return block;
                  else return block + this.elemDelim + elem;
                };
              ...
              function(require, module, exports) {
                ...
                Entity.prototype.setDefaults = function() {
                  ...
                  if (this.def.count !== 0) {
                    ...
                    var self = this;
                    this.def.push(
                      new Template([], function defaultBodyProxy() {
            ...
            7: [
              function(require, module, exports) {
                ...
                BEMXJST.prototype.locals = Tree.methods.concat(
                  "local",
                  "applyCtx",
                  "applyNext",
                  "apply"
                ...
                BEMXJST.prototype.compile = function(code) {
                  ...
                  function _applyCtxWrap(ctx, changes) {
                    // Fast case
                    if (!changes) return self.local({ ctx: ctx }, _applyCtx);
                ...
                BEMXJST.prototype.groupEntities = function(tree) {
                  ...
                  for (var i = 0; i < tree.length; i++) {
                    ...
                    for (var j = 0; j < template.predicates.length; j++) {
                      ...
                      if (pred.key === "block") block = pred.value;
                      else if (pred.key === "elem") elem = pred.value;
                      else continue;
                    ...
                    if (block === null) {
                      var msg =
                        "block(…) subpredicate is not found.\n" +
                ...
                BEMXJST.prototype._run = function(context) {
                  ...
                  else if (Array.isArray(context)) return this.runMany(context);
                  else if (
                ...
                BEMXJST.prototype.runOne = function(json) {
                  ...
                  if (json.block || json.elem) context._currBlock = "";
                  else context._currBlock = context.block;

                  context.ctx = json;
                  if (json.block) {
                    context.block = json.block;

                    if (json.mods) context.mods = json.mods;
                    else if (json.block !== oldBlock || !json.elem)
                      context.mods = {};
                  } else {
                    if (!json.elem) context.block = "";
                    else if (oldCurrBlock) context.block = oldCurrBlock;
                  }
                  ...
                  if (block || elem) context.position++;
                  else context._listLength--;
                ...
                BEMXJST.prototype.applyMode = function(mode, changes) {
                  ...
                  if (!match) {
                    var key = this.classBuilder.build(
                      this.context.block,
                      this.context.elem
                    );
                  ...
                  try {
                    ...
                    if (this.modeName) {
                      ...
                      this.thrownError.message =
                        ...
                        e.message +
                        "\n";
                      this.thrownError.stack =
                        this.thrownError.name +
                        ": " +
                        this.thrownError.message +
                        " " +
                        cause +
              ...
              function(require, module, exports) {
                ...
                function Item(tree, children) {
                  ...
                  for (var i = children.length - 1; i >= 0; i--) {
                    var arg = children[i];
                    if (arg instanceof MatchBase) this.conditions.push(arg);
                    else if (arg === tree.boundBody)
                      this.children[i] = tree.queue.pop();
                    else this.children[i] = arg;
                  }
                }
                ...
                ["attrs", "js", "mods", "elemMods"].forEach(function(method) {
                  AddMatch.prototype[method + "WrapBody"] = function(body) {
                    ...
                    return typeof body !== "function"
                      ? function() {
                          return (this[method] = utils.extend(
                            apply(method) || {},
                            body
                          ));
                        }
                ...
                Tree.checkConditions = function(conditions) {
                  for (var i = 0; i < conditions.length; i++) {
                    ...
                    if (
                      ...
                      condition instanceof CustomMatch
                    )
                      continue;
                    return false;
                  }
                ...
                Tree.prototype.applyMode = function(args, mode) {
                  if (args.length) {
                    throw new Error(
                      "Predicate should not have arguments but " +
                        JSON.stringify(args) +
                        " passed"
                    );
                  }
                ...
                Tree.prototype.xjstOptions = function(options) {
                  this.queue.push(
                    new Item(this, [new CompilerOptions(options)])
                  );
                  return this.boundBody;
                };
                ...
                ["mods", "elemMods", "attrs", "js", "mix"].forEach(function(
                  method
                ) {
            ...
            10: [
              function(require, module, exports) {
                ...
                exports.extend = function(o1, o2) {
                  ...
                  /* istanbul ignore else */
                  for (n in o1) if (o1.hasOwnProperty(n)) res[n] = o1[n];
                  /* istanbul ignore else */
                  for (n in o2) if (o2.hasOwnProperty(n)) res[n] = o2[n];
                  return res;
                };
    ...
    var api = new BEMHTML({ to: "/home/phenotropili/Projects/shri-one" });
...
module.exports = json => templates.apply(json);
